...
<body
	...
	<div
		...
		<img src="<?php echo App::getConf()->app_url; ?>/resources/Under_construction.jpg" alt="Under_construction"
			style="max-width:100%; border-radius:8px; margin-bottom:1em;">
		<div style="width:90%; margin: 2em auto;">
			<p>To jest inna chroniona strona aplikacji internetowej</p>
		</div>
		<div style="margin-top:1em;">
			<a href="<?php echo htmlspecialchars(Utils::relURL('calc')); ?>" class="pure-button">Powrót do kalkulatora</a>
