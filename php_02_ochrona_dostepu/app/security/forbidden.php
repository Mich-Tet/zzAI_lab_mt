...
<body>
    <div class="card">
        ...
        <p>Nie masz uprawnień do przeglądania tej strony. Tylko użytkownik z rolą <strong>admin</strong> może uzyskać
            dostęp.</p>
        <div class="actions">
            <a href="<?php echo _APP_URL; ?>" class="pure-button">Wróć do kalkulatora</a>
            <a href="<?php echo _APP_URL; ?>/app/security/logout.php" class="pure-button pure-button-active">Wyloguj</a>
        </div>
    </div>
</body>
